...
def _build_opportunity(cluster) -> BacktestOpportunity:
    ...
    if isinstance(first, BacktestSignal):
        ...
        return BacktestOpportunity(
            ...
            price_stable_score=first.price_stable_score,
        ...
        return BacktestOpportunity(
            ...
            volume_dry_score=first.get("volume_dry_score", 0),
            price_stable_score=first.get("price_stable_score", 0),
...
def opps_to_dicts(opportunities: list[BacktestOpportunity]) -> list[dict]:
    ...
    for o in opportunities:
        d = {
            ...
            "volume_dry_score": o.volume_dry_score,
            "price_stable_score": o.price_stable_score,
