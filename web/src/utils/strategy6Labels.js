const LABELS = {
  ...
  pivotSource: {
    VCP_LAST_CONTRACTION: 'VCP最后一次收缩', CUP_HANDLE_PIVOT: '杯柄Pivot', PLATFORM_TOP: '平台上沿',
  },
  supportSource: {
  ...
  marketDataStatus: { FRESH: '最新', STALE: '已过期', MISSING: '缺失' },
  ...
  tag: {
    BIG_DOWN_VOLUME: '放量大跌', PRESSURE_NEAR_HIGH: '接近前高压力', UPPER_SHADOW_PRESSURE: '上影线抛压',
