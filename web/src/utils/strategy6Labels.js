const LABELS = {
  ...
  tag: {
    ...
    TREND_SQUEEZE_DATA_INSUFFICIENT: '强势趋势收缩指标无法计算',
    CLOSE_LE_10: '股价不高于10元', CLOSE_LT_52W_LOW_1_30: '股价未高于52周最低价30%',
    CLOSE_LT_52W_HIGH_0_70: '股价低于52周最高价70%', CLOSE_GT_52W_HIGH: '收盘价异常高于52周最高价',
    EMA150_LE_EMA200: 'EMA150不高于EMA200', CLOSE_LE_EMA150: '收盘价不高于EMA150',
    CLOSE_LE_EMA200: '收盘价不高于EMA200', BB_NOT_INSIDE_KC: '布林带未完全收缩至肯特纳通道内',
    ...
    VCP_QUALITY_LOW_RISING_BONUS: 'VCP低点平均抬高奖励 +2',
    VCP_QUALITY_CONTRACTING_HIGHS_BONUS: 'VCP高点收敛且低点抬高奖励 +2',
