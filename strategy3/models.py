...
class Strategy3Indicators:
    ...
    market_return_20: float = 0.0
    market_return_60: float = 0.0
    market_ma20: float = 0.0
    market_ma60: float = 0.0
    market_above_ma20: bool = False
    market_above_ma60: bool = False
    market_volatility_20: float = 0.0
    market_drawdown_60: float = 0.0
    market_data_mode: str = ""
    market_index_fallback: bool = False
    market_index_fallback_reason: str = ""
