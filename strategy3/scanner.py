...
def _build_strategy3_discovery(evaluation, fetch_result=None) -> dict:
    ...
    return {
        ...
        "range_20": ind.range_20,
        "range_compression_ok": ind.range_compression_ok,
        "close_range_5": ind.close_range_5,
        "direction_efficiency_5": ind.direction_efficiency_5,
        "max_up_5": ind.max_up_5,
        "max_down_5": ind.max_down_5,
        "avg_close_position_5": ind.avg_close_position_5,
        ...
        "short_support": risk.short_support,
        "short_support_zone_low": risk.short_support_zone_low,
        "short_support_zone_high": risk.short_support_zone_high,
        "key_support": risk.key_support,
        "key_support_zone_low": risk.key_support_zone_low,
        "key_support_zone_high": risk.key_support_zone_high,
        "strong_support": risk.strong_support,
        "strong_support_zone_low": risk.strong_support_zone_low,
        "strong_support_zone_high": risk.strong_support_zone_high,
        "support_status": risk.support_status,
...
def _evaluation_debug_json(evaluation) -> str:
    return json.dumps({
        ...
        "supportStatus": evaluation.indicators.support_status,
        "breakStatus": evaluation.indicators.break_status,
        "keySupport": evaluation.indicators.key_support,
        "keySupportZoneLow": evaluation.indicators.key_support_zone_low,
        "keySupportZoneHigh": evaluation.indicators.key_support_zone_high,
        "supportSources": evaluation.indicators.support_sources,
