...
- 运行ID：`s6bt-fe1820082982019a2f6a`
...
| trades | 12 |
| unfilled_rate | 0.6842105263157895 |
...
- 每日候选：`s6bt-fe1820082982019a2f6a-daily-candidates.csv`
- 订单：`s6bt-fe1820082982019a2f6a-orders.csv`
- 交易：`s6bt-fe1820082982019a2f6a-trades.csv`
- 参数试验：`s6bt-fe1820082982019a2f6a-parameter-trials.csv`
