...
STRATEGY6_REPORT_COLUMNS = [
    ...
    ("ttm_squeeze_days", "ttm_squeeze_days"),
    ("ttm_fired", "ttm_fired"),
    ("ttm_momentum", "ttm_momentum"),
    ("ttm_previous_momentum", "ttm_previous_momentum"),
    ("ttm_momentum_direction", "ttm_momentum_direction"),
    ("ttm_bb_upper", "ttm_bb_upper"),
    ("ttm_bb_lower", "ttm_bb_lower"),
    ("ttm_kc_upper", "ttm_kc_upper"),
    ("ttm_kc_lower", "ttm_kc_lower"),
    ("ttm_squeeze_score", "ttm_squeeze_score"),
    ("ranking_score", "ranking_score"),
    ("ttm_reasons", "ttm_reasons"),
    ("ttm_risk_tags", "ttm_risk_tags"),
    ...
    ("tail_regime_enabled", "tail_regime_enabled"),
    ("tail_regime_status", "tail_regime_status"),
    ("tail_regime_start_date", "tail_regime_start_date"),
    ("tail_regime_days", "tail_regime_days"),
    ("tail_regime_delta_bic", "tail_regime_delta_bic"),
    ("tail_regime_volume_ratio", "tail_regime_volume_ratio"),
    ("tail_regime_range_ratio", "tail_regime_range_ratio"),
    ("tail_regime_body_ratio", "tail_regime_body_ratio"),
    ("tail_regime_abs_return_ratio", "tail_regime_abs_return_ratio"),
    ("tail_regime_close_dispersion", "tail_regime_close_dispersion"),
    ("tail_regime_low_slope_atr", "tail_regime_low_slope_atr"),
    ("tail_regime_model_version", "tail_regime_model_version"),
    ("tail_regime_reasons", "tail_regime_reasons"),
    ("tail_regime_risks", "tail_regime_risks"),
